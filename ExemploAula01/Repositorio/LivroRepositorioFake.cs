...
public class LivroRepositorioFake : ILivroRepositorio
{
    ...
    public LivroRepositorioFake()
    {
        ...
        var l10 = new Livro { Titulo = "Lobos de Calla", Autor = "Stephen King" };
        var l11 = new Livro { Titulo = "A Dança da Morte", Autor = "Stephen King" };
        ...
        _lidos = new ListaDeLeitura("Lidos", l2, l6, l7, l8, l9, l10);
    }
